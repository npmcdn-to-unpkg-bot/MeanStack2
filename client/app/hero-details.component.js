...
var HeroDetailComponent = (function () {
    function HeroDetailComponent(route, router, service, hero) {
        this.route = route;
        this.router = router;
    ...
    HeroDetailComponent = __decorate([
        core_1.Component({
            ...
            providers: [Hero_1.Hero]
        }), 
        __metadata('design:paramtypes', [router_1.ActivatedRoute, router_1.Router, hero_service_1.HeroService, Hero_1.Hero])
    ], HeroDetailComponent);
